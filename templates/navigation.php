        ...
        if (isset($_SESSION['user'])) {
                echo '
                    <div>
                        <div class="dropdown">
                        <!-- profile icon-->
                            <svg class="dropdown__icon-button"
                                width="34" 
                                height="34" 
                                viewBox="0 0 34 34" 
                                fill="none" 
                            ...
                            <nav class="dropdown__navigation dropdown-active">
                                <ul class="dropdown__list">
                                    <li class="dropdown__list_element dropdown__list_element--hover"><a class="dropdown__list_link" href="#">Profile</a></li>
                                    <li class="dropdown__list_element dropdown__list_element--hover"><a class="dropdown__list_link" href="#">Settings</a></li>
                                    <li class="dropdown__list_element dropdown__list_element--hover"><a class="dropdown__list_link" href="#">Log out</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
